...
class AssertionContacts:
    ...
    @staticmethod
    def assert_contact_list_schema_file(response):
        return AssertionSchemas().validate_json_schema(response, "contact_list_schema.json")

    @staticmethod
    def assert_contact_list_without_select_schema_file(response):
        return AssertionSchemas().validate_json_schema(response, "contact_list_without_select_schema.json")

    @staticmethod
    def assert_add_contact_schema_schema_file(payload):
        return AssertionSchemas().validate_json_schema(payload, "add_contact_schema.json")

    @staticmethod
    def assert_edit_contact_schema_schema_file(payload):
        return AssertionSchemas().validate_json_schema(payload, "edit_contact_schema.json")

    @staticmethod
    def assert_contact_view_schema_file(payload):
        return AssertionSchemas().validate_json_schema(payload, "view_contact_schema.json")
